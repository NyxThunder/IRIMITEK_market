...
const LazyAPIIntegration = React.lazy(() => import('./component/Admin/API/APIIntegration'));
const LazyUpdateAPI = React.lazy(() => import('./component/Admin/API/UpdateAPI'));
const LazyImportAPI = React.lazy(() => import('./component/Admin/API/ImportAPI'));
const LazyExportAPI = React.lazy(() => import('./component/Admin/API/ExportAPI'));
const LazyNewAPI = React.lazy(() => import('./component/Admin/API/NewAPI'));
