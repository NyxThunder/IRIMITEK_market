  ...
  return (
    <div className="privacy-policy-container">
      ...
      <div className="container___">
        ...
        <p>
          At IRMITEK, we value the privacy of our customers and are committed to protecting your
          personal information. This Privacy Policy explains how we collect, use, disclose, and
          safeguard your information when you use our website and services. Please read this Privacy
          Policy carefully. By accessing or using our website and services, you acknowledge that you
          have read, understood, and agree to be bound by all the terms outlined in this Privacy
          Policy.
        </p>
        ...
        <p>
          ...
          an account, place an order, subscribe to our newsletter, participate in contests or
          surveys, or contact us for support. This information may include your name, email address,
          phone number, shipping address, billing address, and payment details.
        </p>
        <h3>1.2 Non-Personal Information:</h3>
        <p>
          When you interact with our website, we may collect non-personal information about your
          device, browsing actions, and usage patterns. This information may include your IP
          address, browser type, operating system, referring URLs, and interactions with our
          website.
        </p>
        ...
        <ul>
          <li>
            To our trusted service providers who assist us in operating our business and providing
            services to you
          </li>
          <li>
          ...
          <li>
            In the event of a merger, acquisition, or sale of all or a portion of our business
            assets
          </li>
        ...
        <p>
          ...
          disclosure, alteration, or destruction. However, please note that no method of
        ...
        <p>
          ...
          collected personal information from a child without parental consent, we will take steps
        ...
        <p>
          ...
          page, and the revised Privacy Policy will take effect immediately upon posting. We
          encourage you to review this Privacy Policy periodically for any updates or changes.
        </p>
        <h2>7. Contact Us</h2>
        <p>
        ...
        <p>
          By using the Irmitek website and services, you agree to the collection, use, and
