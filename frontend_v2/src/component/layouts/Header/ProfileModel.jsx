...
const ProfileModal = ({ user, isAuthenticated }) => {
  ...
  return (
    <>
      <Button className="profile-icon" onClick={handleOpen}>
        <PersonIcon className={`icon smaller ${isOpen ? 'active' : ''}`} fontSize="large" />
        {isOpen ? (
          ...
          <div className="modal-content" ref={modalRef}>
            ...
            <div className="profile-menu">
              {user && user.role === 'admin' && (
                <Button className="profile-menu-item" onClick={dashboardHandler}>
                  <DashboardIcon className="profile-menu-icon" />
                  <span>Dashboard</span>
                </Button>
              )}
              <Button className="profile-menu-item" onClick={accountHandler}>
              ...
              <Button className="profile-menu-item" onClick={cartHandler}>
                <ShoppingCartIcon className="profile-menu-icon" />
                <span>Cart</span>
              </Button>
              {!isAuthenticated ? (
                <Button className="profile-menu-item" onClick={loginHandler}>
                  <LockOpenIcon className="profile-menu-icon" />
                  <span>Login</span>
                </Button>
              ) : (
                <Button className="profile-menu-item" onClick={logoutUserHandler}>
