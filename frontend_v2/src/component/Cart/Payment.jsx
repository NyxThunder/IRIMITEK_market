...
import './Cart.css';
import { Typography, TextField, Grid, Radio, Button, Divider, Link } from '@mui/material';
      ...
      <div className="payemntPage">
        ...
        <div className="paymentPage__container">
          <div className="PaymentBox">
            <Typography variant="h5" component="h1" className="PaymentHeading">
              Payment method
            </Typography>
            <Typography variant="subtitle2" gutterBottom className="securePayemnt">
            ...
            <div className="cardContainer">
              ...
              <Grid container spacing={2} className="cardDetails">
                <Grid item xs={12}>
                  <Typography variant="subtitle2" className="paymentlabelText">
                    Card number
                  </Typography>
          ...
          <div className="payemntAmount">
            ...
            <div className="shipping_Deatils">
              <Typography variant="h6" className="orderSub_heading" style={{ marginTop: '5px' }}>
                BILLING DETAILS
              </Typography>
              ...
              <Typography variant="subtitle2" className="mobileNo">
                {shippingInfo.phoneNo},
              </Typography>

              <Typography variant="subtitle2" className="emailAddress">
                {user.email}
              </Typography>
            </div>
          </div>
