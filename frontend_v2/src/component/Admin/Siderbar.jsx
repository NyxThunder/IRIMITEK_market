      ...
      {!loading && (
        <>
          <div className="admin-sidebar">
            ...
            <ul id="admin-sidebar-sideBarMenu">
              ...
              >
                <li className="admin-sidebar-sideBarMenuItem">
                  ...
                  <span className="admin-sidebar-sideBarMenuItem_text"> Dashboard</span>
                </li>
              </Link>
              ...
              >
                <li className="admin-sidebar-sideBarMenuItem">
                  ...
                  <span className="admin-sidebar-sideBarMenuItem_text"> Products</span>
                </li>
              </Link>
              <Link
              ...
              >
                <li className="admin-sidebar-sideBarMenuItem">
                  ...
                  <span className="admin-sidebar-sideBarMenuItem_text"> API Integration</span>
                </li>
              </Link>
              <Link
              ...
              >
                <li className="admin-sidebar-sideBarMenuItem">
                  ...
                  <span className="admin-sidebar-sideBarMenuItem_text">Add Product</span>
                </li>
              </Link>
            ...
            <div className="placeCenterItems">
              <Button className="adminSidbarbutton" onClick={accountHandler} variant="contained">
                <ManageAccountsIcon fontSize="large" style={{ marginRight: '10px' }} />
                Account
              </Button>
            </div>
          </div>
