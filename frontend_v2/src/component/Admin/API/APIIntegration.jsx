...
import { clearErrors, getAdminApis, deleteApi, connectApi } from '../../../actions/apiAction';
            ...
            <Grid item xs={12} sm={12} md={9} lg={9} xl={9} sx={{ overflowX: 'hidden' }}>
              ...
              <Grid item xs={12} sx={{ mt: 3 }}>
                <Card sx={{ p: 2, boxShadow: 3, borderRadius: 2 }}>
                  ...
                  >
                    <Button onClick={() => navigate('/admin/new/api')} className="mainButton">
                      Add API
                    </Button>
                  </div>
                  <MUIDataTable
