...
const ContactForm = () => {
  ...
  const validationRules = {
    ...
    email: (value) => (!/^[A-Z0-9._%+-]+@[A-Z0-9.-]+\.[A-Z]{2,}$/i.test(value) ? "Invalid email address." : ""),
  ...
  return (
    <Box className="root_contactus">
      ...
      <div className="contact_Container_contactus">
        ...
        <div className="buttonGroup" style={{ display: "flex", justifyContent: "space-between", gap: "1rem" }}>
          <a href="#issue-select" style={{ textDecoration: "none", flex: 1 }}>
            <Button variant="contained" className="mainButton" fullWidth>
              Support Form
            </Button>
          </a>
          <Button variant="contained" className="mainButton" onClick={handleCall} style={{ textDecoration: "none", flex: 1 }} fullWidth>
            Call Us
          </Button>
        </div>
        ...
        <div className="supportForm">
          ...
          <form className="formContainer_container" onSubmit={handleSubmit}>
            ...
            <div className="SelectOption_contact">
              <Typography variant="body2" className="lableText_contact">ISSUE *</Typography>
              <FormControl fullWidth error={!!errors.issue}>
                <Select name="issue" value={values.issue} onChange={handleChange}>
                  <MenuItem value=""><em>Select an Issue</em></MenuItem>
                  <MenuItem value="e-commerce">E-Commerce</MenuItem>
                  <MenuItem value="app">App</MenuItem>
                </Select>
                <Typography variant="caption" color="error">{errors.issue}</Typography>
              </FormControl>
            </div>

            {/* Detail Selection */}
            <div className="SelectOption_contact">
              <Typography variant="body2" className="lableText_contact">DETAIL *</Typography>
              <FormControl fullWidth error={!!errors.detail}>
                <Select name="detail" value={values.detail} onChange={handleChange}>
                  <MenuItem value=""><em>Select a Detail</em></MenuItem>
                ...
                <Typography variant="caption" color="error">{errors.detail}</Typography>
              </FormControl>
            </div>

            {/* Language Selection */}
            <div className="SelectOption_contact">
              <Typography variant="body2" className="lableText_contact">LANGUAGE *</Typography>
              <FormControl fullWidth error={!!errors.language}>
                ...
                <Typography variant="caption" color="error">{errors.language}</Typography>
              </FormControl>
            </div>

            {/* Email Input */}
            <div className="SelectOption_contact">
              <Typography variant="body2" className="lableText_contact">EMAIL *</Typography>
              <TextField 
                fullWidth 
            ...
            {/* Message Input */}
            <div className="SelectOption_contact">
              <Typography variant="body2" className="lableText_contact">MESSAGE *</Typography>
              <TextField
                fullWidth
                multiline
                rows={6}
