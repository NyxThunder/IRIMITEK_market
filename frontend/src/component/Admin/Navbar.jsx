      ...
      <Toolbar>
        <Grid container display="flex" justifyContent="space-between">
          ...
          <Grid item xs={2} sm={1} display={{ xs: "block", md: "none" }}>
            <IconButton onClick={toggleHandler} sx={{ color: "#000", marginTop: "6px", alignSelf: "center" }}>
              <MenuIcon />
            </IconButton>
          </Grid>

          {/* Center - Logo */}
          <Grid item xs={10} sm={11} md={12} display="flex" justifyContent={{ xs: "flex-end", sm: "flex-end", md: "center" }}>
