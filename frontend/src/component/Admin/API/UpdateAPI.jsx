...
function UpdateAPI() {
  ...
  const validationRules = {
    ...
    clientId: (value) => (!value.trim() || value.length < 5 ? "Client ID must be at least 5 characters." : ""),
    clientSecret: (value) => (!value.trim() || value.length < 8 ? "Client Secret must be at least 8 characters." : ""),
  };
                  ...
                  <Card sx={{ p: 3, boxShadow: 3, borderRadius: 2 }}>
                    <form onSubmit={updateApiSubmitHandler}>
                      ...
                      <FormControl fullWidth sx={{ mb: 2 }}>
                        <Select name="category" value={values.name} onChange={handleChange} error={!!errors.name}>
                          <MenuItem value=""><em>Choose API Category</em></MenuItem>
