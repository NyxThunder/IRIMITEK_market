...
export default function SubscriptionPage() {
  ...
  return (
    <Container maxWidth="sm" sx={{ display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", minHeight: "100vh", bgcolor: "#f5f5f5", py: 4 }}>
      ...
      <Box sx={{ mt: 4, textAlign: "center" }}>
        ...
        <Box display="flex" flexDirection={{ xs: "column", sm: "row" }} gap={3} mt={2}>
          <Card sx={{ p: 3, textAlign: "center", boxShadow: 3, width: 200 }}>
            <Typography variant="subtitle1" fontWeight="bold">Basic Plan</Typography>
          ...
          <Card sx={{ p: 3, textAlign: "center", boxShadow: 3, width: 200 }}>
            <Typography variant="subtitle1" fontWeight="bold">Premium Plan</Typography>
            <Typography variant="body2" color="text.secondary">$19.99/month</Typography>
            <Button variant="contained" color="success" sx={{ mt: 2 }}>
              Select
            </Button>
          </Card>
